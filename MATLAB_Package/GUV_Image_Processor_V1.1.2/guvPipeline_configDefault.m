...
Cfg.OutRoot = 'G:\人造细胞\HAO\20251218_output1';
...
%% ============================= 3) 读取设置（Series / Z / 通道） ===========
Cfg.Read = struct();
Cfg.Read.SelectXYs = [63];     % 例如 [2 5 10]；空=[]表示全跑
...
Cfg.Track.Opts.IoUUseFilledMask = true;  % 若追踪内部使用 IoU，可选择用 filled mask 计算
